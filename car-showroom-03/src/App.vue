<template>
    <div>
        ...
        <div class="modal" v-if="showModal">
            <car_form :title="title" :addForm="addForm" :editForm="editForm" :carData="carData" @show-model="showModalx"
                @display-data="setdata" @edit-data="editCarData"></car_form>
        </div>

        <!-- gallery-card.vue component -->
        <div class="car-card">
            <div v-for="item in cars_info" :key="item.id">
                <gallery_card :id="item.id" :name="item.name" :image="item.image" :description="item.description"
